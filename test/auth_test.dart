...
void main() {
  group('Mock Authentication', () {
    ...
    test("Cannot not log out if not initialized", () {
    ...
    test("Should be able to be initialized in less that two seconds", () async {
      await provider.initialize();
      expect(provider.isInitialized, true);
    ...
    test("Logged in user should be able to be get verified", () async {
